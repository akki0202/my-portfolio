...
const Contact = () => {
  return (
    ...
    >
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className=" flex justify-center items-center">
          <form
            action="https://getform.io/f/36d78112-347d-4fa6-8e9d-b82d9e58f65a"
            method="POST"
    ...
    <div className="flex flex-row justify-center items-center bg-gradient-to-r from-black via-gray-900 to-black w-full">
        <a href="https://github.com/akki0202" className="px-4 ms-4 bg-transparent text-white rounded-md hover:scale-110 duration-300 mb-3"><FaGithub size={30} /></a>
        <a href="https://www.linkedin.com/in/akshat-singh-7166b5202/" className="px-4 ms-4 bg-transparent text-white rounded-md hover:scale-110 duration-300 mb-3"><FaLinkedin size={30} /></a>
        <a href="mailto:akshatkng48@gmail.com" className="px-4 ms-4 bg-transparent text-white rounded-md hover:scale-110 duration-300 mb-3"><HiOutlineMail size={30} /></a>
