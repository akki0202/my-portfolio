        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                ...
                <p className='text-gray-200 py-4 max-w-md'>
                    My name is Akshat Singh ,I am a passionate Full-Stack web developer with a knack for transforming ideas into captivating digital experiences. With a strong foundation in web technologies and a creative flair.
